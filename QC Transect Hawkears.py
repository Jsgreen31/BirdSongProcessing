...
if __name__ == '__main__':
    # Define the paths 
    input_directory = 'E:/ARU Data/2024/QC Transect/NE_2024_ARU_files'  # Directory containing bird song recordings
    output_directory = 'E:/ARU Data/HawkEars Outputs/QC Transect 2024'  # Directory to save results
